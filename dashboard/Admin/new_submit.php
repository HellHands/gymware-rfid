...
if (mysqli_affected_rows($con) == 1) {
    ...
    mysqli_query($con, "DELETE FROM user_data WHERE wait='yes'") or die(mysql_error());
...
?></span></td>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>PKR</span><span><?php
echo $total;
?></span></td>
				</tr><tr>
...
?></span></td>
		...
		<aside>
			...
			<div  >
				<p>1). All members must abide our TnC / rules otherwise membership may be withdrawn. </br></br>2). The payment is not transferable and non-refundable.</br></br>3).Fee Should be submitted within 5 business days before subjected to expiration, otherwise 50 PKR/Day will be charged.</br></br>4).All users should dress appropriately Or as per advised.</br></br>5).Smoking is NOT permitted at the Gym site.</br></br>6). A 1000 PKR for breaking/scracthing glasses belonging to "Galaxy the gym" will be imposed.
			</div>
